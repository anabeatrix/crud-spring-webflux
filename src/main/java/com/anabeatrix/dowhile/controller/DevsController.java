package com.anabeatrix.dowhile.controller;

import com.anabeatrix.dowhile.model.Devs;
import com.anabeatrix.dowhile.repository.DevsRepository;
...
public class DevsController {
    ...
    public Mono<ResponseEntity<Devs>> getDevById(@PathVariable(value = "id") String devId) {
        return devsRepository.findById(devId).map(savedDev -> ResponseEntity.ok(savedDev))
    ...
    public Mono<ResponseEntity<Devs>> updateDev(@PathVariable(value = "id") String devId,
        ...
        return devsRepository.findById(devId).flatMap(existingDev -> {
    ...
    public Mono<ResponseEntity<Void>> deleteDev(@PathVariable(value = "id") String devId) {
        return devsRepository.findById(devId).flatMap(existingDev -> devsRepository.delete(existingDev)
